...
### Teaching & Learning
- **Strategy Effectiveness Feedback System** 🆕 - แสดง Alert เตือนและแนะนำกลยุทธ์การสอนแบบ data-informed
  - วิเคราะห์ประวัติการใช้ strategy 30 วันย้อนหลัง
  - เตือนเมื่อใช้วิธีซ้ำๆ แต่ไม่ได้ผล
  - แนะนำ strategy ที่ได้ผลดีในอดีต
  - บันทึกสถานะ PASS/STAY รายบุคคลใน `remedial_tracking`
- **10 Teaching Strategies** - เพิ่มจาก 7 เป็น 10 ตัวเลือก (Re-teach/Review, Individual/Small Group, Continue Forward)
- Teaching Log with 4-step workflow + real-time validation
- Gap Analysis (K-gap, P-gap, A-gap, A2-gap, System-gap, Success)
- Remedial tracking with PASS/STAY status per student
...
**Project changelog:** see [`CHANGELOG.md`](CHANGELOG.md) for detailed update history.

**Project edge + AI summary:** see [`docs/PROJECT-EDGE-AI-SUMMARY-2026-03.md`](docs/PROJECT-EDGE-AI-SUMMARY-2026-03.md) (TH/EN technical summary for handover).
