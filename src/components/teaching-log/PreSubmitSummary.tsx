...
export function PreSubmitSummary({ open, onClose, onConfirm, form, submitting, researchTitle }: PreSubmitSummaryProps) {
  ...
  const items = [
    ...
    { label: "นักเรียนกลุ่มดูแลพิเศษ", value: !form.scPresent ? "ไม่มีในคาบนี้" : form.healthCareStatus === "has" ? "มีในห้อง — ประเมินเป็นเป้าหมายหลัก" : "มีในห้อง (ไม่ได้ประเมินเป็นเป้าหมายหลัก)" },
    { label: "Health Care IDs", value: form.healthCareStatus === "has" ? form.healthCareIds : "[None]" },
