...
**STRICT:** ห้ามแนะนำ Peer Tutor / Buddy System เป็นกลยุทธ์หลัก
เหตุผล: เด็กวัย ป.1–ป.2 ยังขาดทักษะพื้นฐานที่จะสอนเพื่อนได้อย่างมีประสิทธิผล

แนะนำแทน: teacher-led Direct Instruction ซ้ำแบบย่อย / สื่อหลายประสาทสัมผัส (multisensory)
ตัวอย่าง: บัตรคำ การร้องสะกด บล็อกนับ แถบสีเศษส่วน / Micro-teaching + Visual Scaffold

**Precedence:** หากคำแนะนำทั่วไปจาก CORE หรือ K/P/A matrix ขัดแย้งกับบล็อกนี้
สำหรับ ป.1–ป.2 + foundational skills → ยึดบล็อก [CLASSROOM APPROPRIATENESS] ก่อนเสมอ
