...
function atlasStructureSection(mode: LessonPlanGenerationMode): string {
  ...
  **สำคัญ — การตีความ Mastery Score:**
  • Mastery Score ใช้สเกล 1-5 (ไม่ใช่เปอร์เซ็นต์)
  • 4.0-5.0 = นักเรียนส่วนใหญ่เข้าใจเนื้อหาในระดับดี
  • 3.0-3.9 = นักเรียนส่วนใหญ่เข้าใจพอใช้ ควรเสริมความเข้าใจ
  • 2.0-2.9 = นักเรียนส่วนใหญ่ยังต้องการความช่วยเหลือ
  • ต่ำกว่า 2.0 = นักเรียนส่วนใหญ่มีช่องว่างการเรียนรู้มาก
  • ห้ามใช้เครื่องหมาย % กับ Mastery Score โดยเด็ดขาด`;
...
## ขั้นตอนการสอน — รูปแบบหัวข้อแยกชัดเจน (บังคับ)
ห้ามใช้ตารางกิจกรรม ให้ใช้รูปแบบหัวข้อลำดับแทน:

**ขั้นที่ 1 — [ชื่อกิจกรรม] ([X] นาที)**

กิจกรรม: [รายละเอียดกิจกรรม]

สื่อ/อุปกรณ์: [รายการสื่อ]


**ขั้นที่ 2 — [ชื่อกิจกรรม] ([X] นาที)**
...
หมายเหตุ:
- ให้เว้นบรรทัดว่าง 1 บรรทัดหลังแต่ละขั้นตอน เพื่อให้อ่านง่าย
- ห้ามเขียนกระชั้นชิด ต้องมีช่องว่างระหว่างส่วน
...
- เว้นบรรทัดว่าง 2 บรรทัดหลังหัวข้อหลักทุกหัวข้อ (## หรือ ###)
- เว้นบรรทัดว่าง 1 บรรทัดระหว่างย่อหน้า
- ห้ามเขียนกระชั้นชิด ต้องมีช่องว่างเพื่อให้ครูอ่านสบายตา
- ใช้ bold (**) สำหรับหัวข้อย่อยที่สำคัญ
